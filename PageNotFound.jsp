						...
						<div class="header-row">
							...
							<div class="header-column justify-content-end">
								<div class="header-row">
									...
									<li class="social-icons-github"><a href="https://github.com/AtahanEkici/FENG-497" target="_blank" title="GitHub"><i class="fab fa-github"></i></a></li>
									</ul>
							...
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								<h1 class="appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="150" data-title-border>                              <%
                                                                                                                    ...
                                                                                                                    <%       
                                                                                                                        ...
                                                                                                                        {
                                                                                                                    %>                                                                                                                          
                                                                                                                            Sie haben eine Seite gefunden, die nicht existiert.
                                                                                                                    <%       
                                                                                                                        }
